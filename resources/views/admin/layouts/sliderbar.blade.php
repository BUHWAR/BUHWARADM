	...
	<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1">
		<ul class="kt-menu__nav ">
			<li class="kt-menu__section kt-menu__section--first">
				<h4 class="kt-menu__section-text">BÚHWAR</h4>
				<i class="kt-menu__section-icon flaticon-more-v2"></i>
			</li>

			<li class="kt-menu__item " aria-haspopup="true"><a href="{{route('home')}}" class="kt-menu__link "><i
						class="kt-menu__link-icon icon-policeuniF1CA"></i><span
						class="kt-menu__link-text">INICIO</span></a></li>
			...
			<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a
					href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
						<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
							xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="16.554px"
							height="16.554px" viewBox="0 0 432.554 432.554"
							style="enable-background:new 0 0 432.554 432.554;" xml:space="preserve" fill="#1B4F72">
							<g>
								<g>
									<path
										d="M339.53,294.39c-40.824-15.701-52.602-20.406-56.525-21.195c-0.789,0-2.352,0-3.142,0.789l-36.9,25.114
								   ...
								   l23.546-51.812C244.534,376.819,244.534,375.248,242.962,373.676z" />
									<path
										d="M297.917,140.522c-20.41-10.99-51.026-17.268-81.639-17.268c-30.617,0-61.233,6.278-81.643,17.268
					...
					</span><span class="kt-menu__link-text">GUARDIAS</span><i
						class="kt-menu__ver-arrow la la-angle-right"></i></a>
				<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
					<ul class="kt-menu__subnav">
						<li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span
								class="kt-menu__link"><span class="kt-menu__link-text"></span></span></li>
						<li class="kt-menu__item " aria-haspopup="true"><a href="{{route('admin.guardias.index')}}"
			...
			<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a
					...
					</span><span class="kt-menu__link-text">AREAS GEOGRAFICAS</span><i
						class="kt-menu__ver-arrow la la-angle-right"></i></a>
				<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
					<ul class="kt-menu__subnav">
						<li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span
								class="kt-menu__link"><span class="kt-menu__link-text"></span></span></li>
						<li class="kt-menu__item " aria-haspopup="true"><a href="{{route('admin.estados.index')}}"
								class="kt-menu__link "><i
									class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
									class="kt-menu__link-text">Estados</span></a></li>
						<li class="kt-menu__item " aria-haspopup="true"><a href="{{route('admin.municipios.index')}}"
								class="kt-menu__link "><i
									class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
									class="kt-menu__link-text">
									Municipios</span></a></li>
						<li class="kt-menu__item " aria-haspopup="true"><a
								href="{{route('admin.fraccionamientos.index')}}" class="kt-menu__link "><i
									class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
									class="kt-menu__link-text">Fraccionamientos</span></a></li>
					</ul>
				</div>
			</li>
				...
				<ul class="kt-menu__subnav">
					...
					<li class="kt-menu__item " aria-haspopup="true"><a href="{{route('admin.municipios.index')}}"
							class="kt-menu__link "><i
								...
								class="kt-menu__link-text">
							Municipios</span></a></li>
					<li class="kt-menu__item " aria-haspopup="true"><a href="{{route('admin.fraccionamientos.index')}}"
							class="kt-menu__link "><i
								class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
								class="kt-menu__link-text">Fraccionamientos</span></a></li>
				</ul>
